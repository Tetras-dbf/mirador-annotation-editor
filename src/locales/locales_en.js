export const en = {
  ...
  poi_journey: 'Journey',
  poi_journey_none: 'None',
  poi_journey_order: 'Order in journey',
  poi_linked_map: 'Linked map',
  poi_linked_map_none: 'None',
  ...
  poi_target_must_be_point: 'Draw a single point (circle tool) on the image to set this POI\'s location.',
  poi_title: 'Title',
  polygon: 'Polygon',
